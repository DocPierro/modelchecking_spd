function [theta_data,PI_vector,FPE_vector,deff_vec,pvec]=...
                             magnitudeprune(NetDef,W1,W2,PHI,Y,trparms,prparms,PHI2,Y2)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Function implemented based on and using NNSYSID toolbox
%Created for use with SUMO-Toolbox
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
