...
Cosmos $1.grml --loop "#$loopsize" --trace-place "x_1,x_2,x_3,t_a,t_b,t_c" --output-trace $1.dat 0.0 --max-run "$nb_points" --use-van-der-corput --batch 0 --width 0
...
Cosmos $1.grml --loop "#$loopsize" --trace-place "x_1,x_2,x_3,t_a,t_b,t_c" --output-trace $1.dat 0.0 --max-run "$nb_points" --batch 0 --width 0
#grep 'time_' $1.dat > preplot.dat
...
Cosmos Iso_$1.grml --loop "#$loopsize" --trace-place "x_1,x_2,x_3,t_a,t_b,t_c" --output-trace Iso_$1.dat 0.0 --max-run "$nb_points" --batch 0 --width 0
